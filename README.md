...
Продукт будет разработан под самую популярную операционную систему - Windows.
...
* Google Keep, Evernote: нет версии для Windows.
